/* ============================================================
   LES BOURGUIGNOLS : DONNÉES DES DOMAINES (version de démonstration)
   Ce fichier est la « base de données » de la démo. Il est généré et
   peut être ré-exporté depuis la page gestion.html (bouton Exporter).
   Dans la version WordPress, ces données vivent dans le tableau de bord
   (extension « Les Bourguignols » : un domaine = une fiche, avec ses vins).
   Ordre : du nord au sud, comme la liste de l’agence.
   ============================================================ */
window.LB_DATA = {
  "regions": [
    "Champagne",
